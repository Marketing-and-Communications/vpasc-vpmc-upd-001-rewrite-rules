...
class RewriteTester:
    def __init__(self, test_dir: str, debug: bool, use_junit: bool = True, require_host_tests: bool = False):
        ...
        self.require_host_tests = require_host_tests
...
def main():
    ...
    parser.add_argument('--no_junit_results', help='Do not output results in JUnit-format files',
                        action='store_true')
    parser.add_argument('--require_host_tests', help='Require that a test rule is written for each host-based redirect '
                                                     'rule.', action='store_true')
    args = parser.parse_args()

    rewrite_tester = RewriteTester(
        test_dir=args.test_path, debug=args.debug, use_junit=not args.no_junit_results, 
        require_host_tests=args.require_host_tests)
